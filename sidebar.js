(function () {
  ...
  style.textContent = `
    ...
    .sidebar-top {
      ...
      justify-content: flex-start; min-height: 70px;
      border-bottom: 1px solid rgba(255,255,255,0.08);
      overflow: hidden; flex-shrink: 0;
    }
    .sidebar-logo-wrap {
      width: 64px; min-width: 64px; display: flex;
    ...
    .nav-btn {
      ...
      justify-content: flex-start; height: 46px;
      border: none; border-radius: 10px; background: transparent;
      color: rgba(255,255,255,0.65); font-size: 13px; font-weight: 600;
      cursor: pointer; white-space: nowrap; overflow: hidden;
      transition: background 0.18s, color 0.18s, transform 0.15s;
      width: 100%; text-align: left; font-family: inherit; padding: 0;
    }
    .nav-icon-wrap {
    ...
    .nav-label {
      ...
      font-size: 13px; font-weight: 600; padding-right: 12px;
    }
    ...
    .nav-btn:hover .nav-icon-wrap i { color: #fff; }
    .nav-btn.active { background: rgba(44,150,205,0.25); color: #fff; }
    .nav-btn.active .nav-icon-wrap i { color: #5bbfed; }
    .nav-btn.active::before {
      content: ''; position: absolute; left: 0; top: 50%;
      transform: translateY(-50%); width: 3px; height: 26px;
      background: #2C96CD; border-radius: 0 3px 3px 0;
    }
    .nav-tooltip {
      position: fixed; left: 72px; background: #1a1a1a; color: #fff;
    ...
    .logout-btn {
      position: relative; display: flex; align-items: center;
      justify-content: flex-start; height: 46px; border: none;
      border-radius: 10px; background: none;
      color: rgba(255,100,100,0.85); font-size: 13px; font-weight: 600;
      cursor: pointer; white-space: nowrap; overflow: hidden;
    ...
    aside.innerHTML = `
      ...
      <nav class="nav-menu">
        ...
        <button class="nav-btn ${active('tenants.html')}" id="sidebar-tenants-btn" data-href="tenants.html">
          <span class="nav-icon-wrap"><i class="fa-solid fa-users"></i></span>
        ...
        <button class="nav-btn ${active('payment.html')}" data-href="payment.html">
          <span class="nav-icon-wrap"><i class="fa-solid fa-credit-card"></i></span>
      ...
      <div class="sidebar-bottom">
        <button class="logout-btn" id="sidebar-logout-btn">
          <span class="logout-icon-wrap"><i class="fa-solid fa-right-from-bracket"></i></span>
